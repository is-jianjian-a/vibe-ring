...
final class ConnectionManager: ObservableObject {
    private static let logger = Logger(subsystem: "app.vibering.mobile", category: "ConnectionManager")
    ...
    @Published var notifyPermissions: Bool {
        didSet { UserDefaults.standard.set(notifyPermissions, forKey: "vibering.notify.permissions") }
    }
    @Published var notifyQuestions: Bool {
        didSet { UserDefaults.standard.set(notifyQuestions, forKey: "vibering.notify.questions") }
    }
    @Published var notifyCompletions: Bool {
        didSet { UserDefaults.standard.set(notifyCompletions, forKey: "vibering.notify.completions") }
    }
    @Published var silentCompletions: Bool {
        didSet { UserDefaults.standard.set(silentCompletions, forKey: "vibering.notify.silentCompletions") }
    }
    ...
    private var savedToken: String? {
        get { UserDefaults.standard.string(forKey: "vibering.token") }
        set { UserDefaults.standard.set(newValue, forKey: "vibering.token") }
    }
    private var savedMacName: String? {
        get { UserDefaults.standard.string(forKey: "vibering.macName") }
        set { UserDefaults.standard.set(newValue, forKey: "vibering.macName") }
    }
    var pairedAt: Date? {
        get {
            let interval = UserDefaults.standard.double(forKey: "vibering.pairedAt")
            return interval > 0 ? Date(timeIntervalSince1970: interval) : nil
        }
        set {
            if let date = newValue {
                UserDefaults.standard.set(date.timeIntervalSince1970, forKey: "vibering.pairedAt")
            } else {
                UserDefaults.standard.removeObject(forKey: "vibering.pairedAt")
            }
        }
    }
    ...
    init() {
        ...
        self.notifyPermissions = defaults.object(forKey: "vibering.notify.permissions") as? Bool ?? true
        self.notifyQuestions = defaults.object(forKey: "vibering.notify.questions") as? Bool ?? true
        self.notifyCompletions = defaults.object(forKey: "vibering.notify.completions") as? Bool ?? true
        self.silentCompletions = defaults.object(forKey: "vibering.notify.silentCompletions") as? Bool ?? false
    ...
    private func startNetworkMonitor() {
        ...
        monitor.start(queue: DispatchQueue(label: "app.vibering.mobile.network"))
