...
### Delete entirely
- `Sources/VibeRingApp/TerminalSessionAttachmentProbe.swift` (1170 lines)

### New file
- `Sources/VibeRingApp/TerminalJumpTargetResolver.swift` (~250 lines) — AppleScript snapshot matching for jump target precision only

### Simplify or delete
- `Sources/VibeRingCore/ClaudeSessionRegistry.swift` (159 lines) — delete or gut to ~30 lines for pending-interaction-only persistence

### Modify: `Sources/VibeRingCore/AgentSession.swift`
...
### Modify: `Sources/VibeRingCore/SessionState.swift`
...
### Modify: `Sources/VibeRingApp/AppModel.swift` (~450 lines removed)
...
### Modify: `Sources/VibeRingCore/BridgeServer.swift`
