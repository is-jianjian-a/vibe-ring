...
public enum HookSkipConfiguration {
    /// Preferred Vibe Ring environment key for disabling hooks in this process.
    /// Vibe Ring 推荐使用的当前进程 hook 跳过开关。
    public static let vibeRingSkipKey = "VIBE_RING_SKIP_HOOKS"
    ...
    public static func shouldSkipHooks(environment: [String: String]) -> Bool {
        isTruthy(environment[vibeRingSkipKey])
