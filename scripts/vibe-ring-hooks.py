#!/usr/bin/env python3
"""
Vibe Ring hook client — portable Python implementation.

Drop-in replacement for the Swift VibeRingHooks binary.
...
def socket_path():
    path = os.environ.get("VIBE_RING_SOCKET_PATH") or \
