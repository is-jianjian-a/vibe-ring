...
extension Notification.Name {
    ...
    static let vibeRingSelectSetupTab = Notification.Name("vibeRingSelectSetupTab")
}
...
final class AppModel {
    ...
    func showOnboarding() {
        showSettings()
        NotificationCenter.default.post(name: .vibeRingSelectSetupTab, object: nil)
    }
    ...
    func approvePermission(for sessionID: String, action: ApprovalAction) {
        ...
        switch action {
        case .deny:
            resolution = .deny(message: "Permission denied in Vibe Ring.", interrupt: false)
    ...
    private func permissionResolution(for approved: Bool) -> PermissionResolution {
        ...
        return .deny(message: "Permission denied in Vibe Ring.", interrupt: false)
    }
