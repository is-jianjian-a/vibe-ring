...
/// Discovered Mac running Vibe Ring.
...
/// Uses NWBrowser to discover macOS instances advertising `_vibering._tcp`.
@MainActor
final class BonjourDiscovery: ObservableObject {
    private static let logger = Logger(subsystem: "app.vibering.mobile", category: "BonjourDiscovery")
