#!/bin/zsh
#
# Create a local self-signed code signing identity for Vibe Ring dev
...
IDENTITY_NAME="Vibe Ring Dev Local"
...
echo "you give Vibe Ring Dev will persist across rebuilds."
