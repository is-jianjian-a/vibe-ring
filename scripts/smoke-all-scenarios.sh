...
base_dir="${VIBE_RING_HARNESS_ARTIFACT_DIR:-$repo_root/output/harness/smoke-all-$timestamp}"
...
for scenario in "${scenarios[@]}"; do
    ...
    VIBE_RING_HARNESS_SCENARIO="$scenario" \
    VIBE_RING_HARNESS_ARTIFACT_DIR="$scenario_dir" \
