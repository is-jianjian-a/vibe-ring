...
public enum ManagedHooksBinary {
    public static let binaryName = "VibeRingHooks"
    ...
    private static func installDirectory(fileManager: FileManager) -> URL {
        fileManager.homeDirectoryForCurrentUser
            ...
            .appendingPathComponent("VibeRing", isDirectory: true)
...
public enum HooksBinaryLocator {
    public static func locate(
        ...
        if let explicitPath = environment["VIBE_RING_HOOKS_BINARY"] ?? environment["VIBE_ISLAND_HOOKS_BINARY"],
        ...
        let candidates = [
            executableDirectory?.appendingPathComponent("VibeRingHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("VibeRingHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("Helpers/VibeRingHooks"),
            ...
            #endif
            return [
                currentDirectory.appendingPathComponent(".build/\(archTriple)/release/VibeRingHooks"),
                currentDirectory.appendingPathComponent(".build/release/VibeRingHooks"),
                ...
                currentDirectory.appendingPathComponent(".build/\(archTriple)/debug/VibeRingHooks"),
                currentDirectory.appendingPathComponent(".build/debug/VibeRingHooks"),
