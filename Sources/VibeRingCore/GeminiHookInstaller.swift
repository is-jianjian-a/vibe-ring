...
public enum GeminiHookInstaller {
    ...
    private static func isManagedGroup(_ group: [String: Any], managedCommand: String?) -> Bool {
        ...
        return hooks.contains { hook in
            ...
            return isVibeRingGeminiHookCommand(command)
        }
    }

    private static func isVibeRingGeminiHookCommand(_ command: String) -> Bool {
        let normalized = command.lowercased()
        return (normalized.contains("viberinghooks") || normalized.contains("vibeislandhooks"))
