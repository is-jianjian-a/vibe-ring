...
public enum BridgeSocketLocation {
    ...
    private static var stableDirectoryURL: URL {
        ...
        return appSupport.appendingPathComponent("VibeRing")
    }
    ...
    public static func currentURL(environment: [String: String] = ProcessInfo.processInfo.environment) -> URL {
        if let path = environment["VIBE_RING_SOCKET_PATH"], !path.isEmpty {
...
public enum BridgeCommand: Equatable, Codable, Sendable {
    ...
    case processHermesPlugin(HermesPluginPayload)
    ...
    public init(from decoder: any Decoder) throws {
        ...
        case .processHermesPlugin:
            self = .processHermesPlugin(try container.decode(HermesPluginPayload.self, forKey: .hermesPlugin))
        }
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        case let .processHermesPlugin(payload):
            try container.encode(CommandType.processHermesPlugin, forKey: .type)
            try container.encode(payload, forKey: .hermesPlugin)
        }
    }
}
